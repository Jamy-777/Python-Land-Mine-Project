...
saved_scaler = joblib.load("land_mines_scaler.joblib")
...
h = st.number_input("Enter the height of the sensor from the ground(cm):", min_value=0.0, max_value=20.0, step=0.5, value=10.0)
s = st.number_input("Soil type depending on moisture content(1-6):", min_value=1.0, max_value=6.0, step=1.0, value=3.0)
